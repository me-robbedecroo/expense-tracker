...
export default function HomeScreen({ navigation }) {
    ...
    const [lastWeekOfMonth, setLastWeekOfMonth] = useState(false);
    ...
    const loadData = async () => {
        ...
        const endOfMonth = new Date(weekEnd.getFullYear(), weekEnd.getMonth() + 1, 0);
        setLastWeekOfMonth(weekEnd >= endOfMonth);
    };
            ...
            <View style={styles.header}>
                {lastWeekOfMonth && (
                    <View style={styles.badge}>
                        <Text style={styles.badgeText}>🏠 Huur</Text>
                    </View>
                )}
